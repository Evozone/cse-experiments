...
// Function to perform the SJF algorithm
void shortJobSchedule(Prcs *processes, int N) {
    ...
    while (executed < n) {
        ...
        // Resort the arrived processes based on their burst times
